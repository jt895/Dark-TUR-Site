      ...
      <Section background="grey" padding="md">
        <div className="max-w-6xl mx-auto grid grid-cols-1 md:grid-cols-3 gap-6">
          ...
          <Card>
            ...
            <p className="text-gray-700 leading-relaxed">{study.role}</p>
          </Card>
          <Card>
            <h3 className="text-sm font-semibold text-gray-500 mb-2 uppercase tracking-wide">
              Outcome
      ...
      <Section background="white">
        <div className="max-w-4xl mx-auto space-y-12">
          <div>
            ...
            <p className="text-lg text-gray-700 leading-relaxed">{study.realProblem}</p>
          </div>
          ...
          <div>
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
              {study.changed.map((item: string, index: number) => (
                <Card key={index} className="bg-[#F7F7F7] border-l-4 border-[#00796B]">
