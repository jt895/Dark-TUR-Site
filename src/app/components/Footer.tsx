      ...
      <div className="max-w-7xl mx-auto px-6 lg:px-8 py-14">
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-10 mb-10">
          <div className="lg:col-span-2">
            ...
            <p className="text-[#B8C9C6] leading-relaxed max-w-md">
          ...
          <div>
            ...
            <ul className="space-y-3">
              <li><Link to="/how-we-work" className="text-[#B8C9C6] hover:text-[#9AE8D5] transition-colors">How We Work</Link></li>
              <li><Link to="/services" className="text-[#B8C9C6] hover:text-[#9AE8D5] transition-colors">Services</Link></li>
              <li><Link to="/case-studies" className="text-[#B8C9C6] hover:text-[#9AE8D5] transition-colors">Case Studies</Link></li>
              <li><Link to="/about" className="text-[#B8C9C6] hover:text-[#9AE8D5] transition-colors">About</Link></li>
            </ul>
          </div>

          <div>
            <h4 className="text-lg font-semibold mb-4">Get in Touch</h4>
            <ul className="space-y-3 text-[#B8C9C6]">
        ...
        <div className="border-t border-[#163135] pt-8 flex flex-col md:flex-row justify-between items-center text-sm text-[#88A09B]">
